...
class Customer(StripeModel):
    ...
    def subscribe(
        ...
        :param payment_behavior: Control the payment behavior for this subscription.
        :type payment_behavior: str # 'allow_incomplete' | 'error_if_incomplete' | 'pending_if_incomplete'
